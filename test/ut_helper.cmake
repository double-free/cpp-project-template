...
# CMake function to create yyple yy UTs
#
# Parameters:
...
function(default_yy_test)
  cmake_parse_arguments(DEFAULT_YY_TEST
    ""
    "DIR_NAME"
    "EXTRA_SRCS"
    ${ARGN}
  )
  aux_source_directory("../src/${DEFAULT_YY_TEST_DIR_NAME}" SRCS)
  aux_source_directory(${DEFAULT_YY_TEST_DIR_NAME} TEST_SRCS)
  yy_test(
    NAME
      ${DEFAULT_YY_TEST_DIR_NAME}
    SRCS
      ${SRCS}
      ${TEST_SRCS}
      ${DEFAULT_YY_TEST_EXTRA_SRCS}
    DEPS
      gtest
      gtest_main
